...
EnergyConversionDescription:
	...
	line "discard pile into your hand. then,"
	line "take 10 damage."
	done
...
LeekSlapDescription:
	...
	line "Fails. You can only use this attack,"
	line "once per duel."
	done
...
ImposterProfessorOakDescription:
	...
	line "into their deck, then draws 7 cards."
	done
...
LassDescription:
	text "Both Players show their hand;"
	line "shuffle all Trainer cards in their"
	line "hands into their decks."
	done
