...
; if multiple cards are tied for the lowest HP, the one with the highest PLAY_AREA_* is returned.
GetBenchPokemonWithLowestHPEffect:
...
TripleAttackX10_AIEffect:
	ld a, 30 / 2
	lb de, 0, 30
	jp SetExpectedAIDamage

TripleAttackX10_MultiplierEffect:
	ld hl, 10
	call LoadTxRam3
	ldtx de, DamageCheckIfHeadsXDamageText
	ld a, 3
...
Selfdestruct60DMGEffect:
	ld a, 60
	call DealRecoilDamageToSelf
	;fallthrough
Selfdestruct10Effect:
	ld a, TRUE
...
DiveBomb_Success50PercentEffect:
	ldtx de, SuccessCheckIfHeadsAttackIsSuccessfulText
	call TossCoin_BankB
	jr c, .heads
; tails
...
TripleAttackX20_AIEffect:
	ld a, 60 / 2
	lb de, 0, 60
	jp SetExpectedAIDamage

TripleAttackX20_MultiplierEffect:
	ld hl, 20
	call LoadTxRam3
	ldtx de, DamageCheckIfHeadsXDamageText
	ld a, 3
...
Selfdestruct40DMGEffect:
	ld a, 40
	call DealRecoilDamageToSelf
	jp Selfdestruct10Effect
...
Selfdestruct80DMGEffect:
	ld a, 80
	call DealRecoilDamageToSelf
	;fallthrough
Selfdestruct20Effect:
; own bench
	ld a, TRUE
	ld [wIsDamageToSelf], a
	ld a, 20
...
Selfdestruct100DMGEffect:
	ld a, 100
	call DealRecoilDamageToSelf
	jp Selfdestruct20Effect
